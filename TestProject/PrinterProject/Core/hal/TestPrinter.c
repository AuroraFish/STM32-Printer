...
{
    digitalWrite(PIN_STB1, RESET);
    digitalWrite(PIN_STB2, RESET);
    digitalWrite(PIN_STB3, RESET);
    digitalWrite(PIN_STB4, RESET);
    digitalWrite(PIN_STB5, RESET);
    digitalWrite(PIN_STB6, RESET);
}
...
static void init_printing()
{
    ...
    set_stb_idle();
    digitalWrite(PIN_LAT, SET);
    // POWER ON
    digitalWrite_vhen(PIN_VHEN, SET);
}
...
static void stop_printing()
{
    ...
    // POWER OFF
    digitalWrite_vhen(PIN_VHEN, RESET);
    set_stb_idle();
    digitalWrite(PIN_LAT, SET);
}
